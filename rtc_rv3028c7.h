...
#ifndef RTC_RV3028C7_H_
#define RTC_RV3028C7_H_
...
bool updateAlarm();  // TODO: This is only used for testing.  Remove for production code.
...
// TODO: The following functions are for testing only.
...
void setTimer(bool timer_repeat, uint16_t timer_frequency, uint16_t timer_value, bool setInterrupt, bool start_timer, bool enable_clock_output);
void enableTimer();
void disableTimer();
...
void enableTrickleCharge(uint8_t tcr); //Trickle Charge Resistor default 15k
...
uint8_t readRVRegister(uint8_t addr);
